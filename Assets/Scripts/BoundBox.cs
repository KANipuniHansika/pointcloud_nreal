...
public class BoundBox : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        */
        ...
        if (textReceivedFromServer.Contains("Scale") || textReceivedFromServer.Contains("scale") || textReceivedFromServer.Contains("Size") || textReceivedFromServer.Contains("size"))
        {
            if (scaleCube == false && grabCube == false && rotateCube == false)
            {
                scaleCube = true;
            } 
        }
        ...
        if (textReceivedFromServer.Contains("Grab") || textReceivedFromServer.Contains("grab"))
        {
            if (scaleCube == false && grabCube == false && rotateCube == false)
            {
                grabCube = true;
        ...
        if (textReceivedFromServer.Contains("Rotate") || textReceivedFromServer.Contains("rotate"))
        {
            if (scaleCube == false && grabCube == false && rotateCube == false)
            {
                rotateCube = true;
